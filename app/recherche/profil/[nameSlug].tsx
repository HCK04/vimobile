  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {entity.id && (
          <Pressable 
            onPress={() => router.push({ pathname: '/rendez-vous/[doctorSlug]', params: { doctorSlug: String(entity.slug || entity.id) } })} 
            style={styles.cta}
          >
        ...
        <Pressable onPress={() => router.push('/patient/mes-rdv' as any)} style={styles.secondaryCta}>
