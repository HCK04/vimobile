...
export default function FamiliauxScreen() {
  ...
  const SECTION = 'antecedents_familiaux';
  const TITLE = 'Antécédents familiaux';
  const ICON = 'people';
  const COLOR = '#06B6D4';
  ...
  const handleAddItem = async () => {
    if (!newItem.trim()) {
      Alert.alert('Erreur', 'Veuillez saisir un antécédent familial');
      return;
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Pressable style={styles.noneCard} onPress={handleToggleNone}>
          <View style={{ flex: 1 }}>
            <Text style={styles.noneTitle}>Aucun antécédent familial</Text>
            <Text style={styles.noneText}>Pas d'antécédents familiaux connus</Text>
          </View>
        ...
        {!hasNone && items.length === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyTitle}>Aucun antécédent familial</Text>
            <Text style={styles.emptyText}>Ajoutez les antécédents familiaux pour un suivi optimal</Text>
          </View>
        )}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Ajouter un antécédent</Text>
            ...
            <View style={styles.modalBody}>
              <EnhancedTextInput
                ...
                placeholder="Ex: Cancer du sein (mère)"
                autoCapitalize="sentences"
                maxLength={200}
                showCharCount
                icon="people"
                helperText="Saisissez un antécédent à la fois"
                autoFocus
              />
