...
export default function OperationsScreen() {
  ...
  const SECTION = 'operations_chirurgicales';
  const TITLE = 'Opérations chirurgicales';
  const ICON = 'cut';
  const COLOR = '#EC4899';
  ...
  const handleAddItem = async () => {
    if (!newItem.trim()) {
      Alert.alert('Erreur', 'Veuillez saisir une opération');
      return;
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Pressable style={styles.noneCard} onPress={handleToggleNone}>
          <View style={{ flex: 1 }}>
            <Text style={styles.noneTitle}>Aucune opération</Text>
            <Text style={styles.noneText}>Je n'ai subi aucune opération chirurgicale</Text>
          </View>
        ...
        {!hasNone && items.length === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyTitle}>Aucune opération enregistrée</Text>
            <Text style={styles.emptyText}>Ajoutez vos opérations chirurgicales pour un suivi optimal</Text>
          </View>
        )}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Ajouter une opération</Text>
            ...
            <View style={styles.modalBody}>
              <EnhancedTextInput
                ...
                placeholder="Ex: Appendicectomie en 2015"
                autoCapitalize="sentences"
                maxLength={200}
                showCharCount
                icon="cut"
                helperText="Saisissez une opération à la fois"
                autoFocus
              />
