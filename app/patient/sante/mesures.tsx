...
export default function MesuresScreen() {
  ...
  const SECTION = 'mesures';
  const TITLE = 'Mesures & Constantes';
  const ICON = 'stats-chart';
  const COLOR = '#14B8A6';
  ...
  const handleAddItem = async () => {
    if (!newItem.trim()) {
      Alert.alert('Erreur', 'Veuillez saisir une mesure');
      return;
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Pressable style={styles.noneCard} onPress={handleToggleNone}>
          <View style={{ flex: 1 }}>
            <Text style={styles.noneTitle}>Aucune mesure</Text>
            <Text style={styles.noneText}>Aucune mesure enregistrée</Text>
          </View>
        ...
        {!hasNone && items.length === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>Ajoutez vos mesures et constantes pour un suivi optimal</Text>
          </View>
        )}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalBody}>
              <EnhancedTextInput
                label="Mesure / Constante"
                value={newItem}
                onChangeText={setNewItem}
                placeholder="Ex: Poids: 70kg, Tension: 12/8"
                autoCapitalize="none"
                maxLength={100}
                showCharCount
                icon="stats-chart"
                helperText="Saisissez une mesure à la fois"
                autoFocus
              />
