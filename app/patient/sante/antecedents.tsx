...
export default function AntecedentsScreen() {
  ...
  const SECTION = 'antecedents_medicaux';
  const TITLE = 'Antécédents médicaux';
  const ICON = 'pulse';
  const COLOR = '#EF4444';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Pressable style={styles.noneCard} onPress={handleToggleNone}>
          <View style={{ flex: 1 }}>
            <Text style={styles.noneTitle}>Aucun antécédent</Text>
            <Text style={styles.noneText}>Je n'ai aucun antécédent médical</Text>
          </View>
        ...
        {!hasNone && items.length === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>Ajoutez vos antécédents médicaux pour un suivi optimal</Text>
          </View>
        )}
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalBody}>
              <EnhancedTextInput
                ...
                placeholder="Ex: Diabète diagnostiqué en 2015"
