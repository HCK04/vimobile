...
export default function AllergiesScreen() {
  ...
  const handleAddItem = async () => {
    if (!newItem.trim()) {
      Alert.alert('Erreur', 'Veuillez saisir une allergie');
      return;
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Pressable style={styles.noneCard} onPress={handleToggleNone}>
          <View style={{ flex: 1 }}>
            <Text style={styles.noneTitle}>Aucune allergie</Text>
            <Text style={styles.noneText}>Je n'ai aucune allergie connue</Text>
          </View>
        ...
        {!hasNone && items.length === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyTitle}>Aucune allergie enregistrée</Text>
            <Text style={styles.emptyText}>Ajoutez vos allergies pour un suivi médical optimal</Text>
          </View>
        )}
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalBody}>
              <EnhancedTextInput
                ...
                placeholder="Ex: Pollen, Arachide, Pénicilline..."
                autoCapitalize="sentences"
                maxLength={200}
                showCharCount
                icon="warning"
                helperText="Saisissez une allergie à la fois"
                autoFocus
              />
